    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md animate-scale-in">
        ...
        <div className="glass-card p-8 shadow-2xl shadow-black/30">
          {/* Google button */}
          <button className="mb-6 flex w-full items-center justify-center gap-3 rounded-xl border border-surface-border bg-background/50 px-4 py-3 text-sm font-medium text-muted hover:bg-surface-hover hover:text-foreground hover:border-muted-dark transition-all duration-200">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <Link href={isLogin ? "/" : "/onboarding"}>
              <button
                type="submit"
                className="btn-neon mt-2 flex w-full items-center justify-center gap-2 py-3 text-sm"
              >
